  ...
  <div class="fixed z-[9999] flex 
    ...
    <a 
      ...
      class="flex items-center justify-center text-white shadow-md transition-all duration-300 
             ...
             md:w-60 md:h-auto md:px-5 md:py-3.5 md:rounded-l-xl md:rounded-r-none md:hover:-translate-x-1 md:hover:scale-100 md:justify-start md:gap-4"
    >
      ...
      <span class="hidden md:block text-lg font-medium whitespace-nowrap">Ruf uns an!</span>
    </a>
    ...
    <a 
      ...
      class="flex items-center justify-center text-white shadow-md transition-all duration-300 
             ...
             md:w-60 md:h-auto md:px-5 md:py-3.5 md:rounded-l-xl md:rounded-r-none md:hover:-translate-x-1 md:hover:scale-100 md:justify-start md:gap-4"
    >
      <svg class="w-6 h-6 md:w-6 md:h-6 shrink-0" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <span class="hidden md:block text-lg font-medium whitespace-nowrap">Chatte mit uns!</span>
    </a>
