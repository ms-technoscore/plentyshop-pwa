<template>
  <div
    class="sticky-contact fixed z-[90] flex w-max
           bottom-[80px] left-1/2 -translate-x-1/2 flex-row justify-center gap-4 p-2 bg-white/95 backdrop-blur-md shadow-[0_5px_20px_rgba(0,0,0,0.12)] rounded-full
           md:bottom-auto md:top-1/2 md:-translate-y-1/2 md:left-auto md:right-0 md:flex-col md:gap-1.5 lg:gap-2.5 xl:gap-3 2xl:gap-4 md:p-0 md:bg-transparent md:shadow-none md:backdrop-blur-none md:rounded-none md:translate-x-0"
  >
    <a
      ...
      class="sticky-btn flex items-center justify-center text-white bg-[#3B82F6] shadow-md transition-all duration-300
             ...
             md:w-auto md:h-auto md:justify-start md:px-3.5 md:py-2 lg:px-4 lg:py-2.5 xl:px-5 xl:py-3 2xl:px-7 2xl:py-4 md:rounded-l-xl md:rounded-r-none md:hover:-translate-x-1 md:hover:scale-100"
    >
      <svg
        class="sticky-icon w-5 h-5 md:w-4 md:h-4 xl:w-5 xl:h-5 2xl:w-6 2xl:h-6 shrink-0"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
      ...
      <span class="sticky-label hidden md:block text-xs xl:text-sm 2xl:text-base font-medium whitespace-nowrap">Ruf uns an!</span>
    </a>
    ...
    >
      ...
      <span class="sticky-label hidden md:block text-xs xl:text-sm 2xl:text-base font-medium whitespace-nowrap">Schreib uns!</span>
    </a>
    ...
    >
      ...
      <span class="sticky-label hidden md:block text-xs xl:text-sm 2xl:text-base font-medium whitespace-nowrap">Chatte mit uns!</span>
    </a>
  </div>
</template>
